...
<body class="flex items-center justify-center min-h-screen bg-black">
  ...
  <div class="w-full max-w-md bg-white shadow-2xl rounded-2xl p-8 border border-gray-200">
    <h1 class="text-3xl font-extrabold text-indigo-700 text-center mb-6">Create User</h1>
    ...
    <form action="<?=site_url('users/create');?>" method="post" class="space-y-5">
      ...
      <div class="flex items-center justify-between pt-4">
        <a href="<?=site_url('users/show');?>" class="text-sm text-gray-500 hover:text-indigo-600">← Back to Show</a>
        <button type="submit"
